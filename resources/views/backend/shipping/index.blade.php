...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Envio list</h6>
      <a href="{{route('shipping.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Adicione o frete</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="#delModal{{$user->id}}Label">Excluir usuário</h5>
                            ...
                            <div class="modal-body">
                              <form method="post" action="{{ route('banners.destroy',$user->id) }}">
                                @csrf
                                @method('delete')
                                <button type="submit" class="btn btn-danger" style="margin:auto; text-align:center">Excluir usuário permanentemente</button>
                              </form>
                            </div>
                          </div>
                        </div>
        ...
        @else
          <h6 class="text-center">Nenhum frete encontrado!!! </h6>
        @endif
      </div>
    </div>
</div>
        ...
        $.ajaxSetup({
          ...
          $('.dltBtn').click(function(e){
            var form=$(this).closest('form');
              ...
              swal({
                    title:"Tem certeza?",
                    text: "Depois de excluído, você não poderá recuperar esses dados!",
                    icon: "aviso",
                    buttons: true,
                    dangerMode: true,
                })
