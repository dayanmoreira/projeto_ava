    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Insira o título"  value="{{$product->title}}" class="form-control">
          @error('title')
        ...
        <div class="form-group">
          ...
          <input type="checkbox" name='is_featured' id='is_featured' value='{{$product->is_featured}}' {{(($product->is_featured) ? 'checked' : '')}}> Sim
        </div>
              {{-- {{$categories}} --}}
        ...
        <div class="form-group">
          ...
          <input id="price" type="number" name="price" placeholder="Insira o preço"  value="{{$product->price}}" class="form-control">
          @error('price')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <input id="discount" type="number" name="discount" min="0" max="100" placeholder="Insira o desconto"  value="{{$product->discount}}" class="form-control">
          @error('discount')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              @foreach($items as $item)
                ...
                // dd($data);
                @endphp
              <option value="S"  @if( in_array( "S",$data ) ) selected @endif>Pequena</option>
              <option value="M"  @if( in_array( "M",$data ) ) selected @endif>Média</option>
