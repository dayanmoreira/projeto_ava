<div id="messages">
    ...
    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
        ...
        <div id="message-items">
            ...
            <div>
                <div class="text-truncate">Eu sou um bom menino?A razão pela qual pergunto é porque alguém me disse que as pessoas dizem isso a todos os cães, mesmo que não sejam bons...</div>
                <div class="small text-gray-500">testar</div>
            </div>
            </a> --}}
        </div>
        <a class="dropdown-item text-center small text-gray-500" href="{{route('message.index')}}">Leia mais mensagens</a>
    </div>
</div>
