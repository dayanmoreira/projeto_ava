 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <div class="table-responsive">
                ...
                <tr>
                    ...
                    <td>
                     <ul style="list-style:none">
                          @for($i=1; $i<=5;$i++)
                          @if($review->rate >=$i)
                            <li style="float:left;color:#b56c79;"><i class="fa fa-star"></i></li>
                          @else
                            <li style="float:left;color:#b56c79;"><i class="far fa-star"></i></li>
                          @endif
                        @endfor
                     </ul>
                    </td>
        ...
        @else
          <h6 class="text-center">Nenhuma crítica encontrada !!!</h6>
        @endif
      </div>
    </div>
</div>
