						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									<h3>Escreva-nos uma mensagem @auth @else<span style="font-size:12px;" class="text-danger">[Você precisa fazer login primeiro]</span>@endauth</h3>
								</div>
									...
									<div class="row">
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="subject" type="text" id="subject" placeholder="Digite seu assunto">
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
						...
						<div class="col-lg-4 col-12">
							<div class="single-head">
								<div class="single-info">
									...
									<h4 class="title">Ligue para nós agora:</h4>
									<ul>
