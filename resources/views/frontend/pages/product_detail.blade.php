...
@endsection
@section('title','DonutsYume || PRODUCT DETAIL')
					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="">Detalhes da loja</a></li>
							</ul>
						</div>
					</div>
				</div>
								...
								<div class="row">
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<!-- Color -->
											{{-- <div class="color">
												<h4>Opções disponíveis <span>Cor</span></h4>
												<ul>
											...
											<div class="product-buy">
												...
												@endif
												<p class="availability">Estoque : @if($product_detail->stock>0)<span class="badge badge-success">{{$product_detail->stock}}</span>@else <span class="badge badge-danger">{{$product_detail->stock}}</span>  @endif</p>
											</div>
											<!--/ End Product Buy -->
										</div>
									</div>
														...
														<div class="row">
															<div class="col-12">
                                                                    ...
                                                                    <div class="row">
																		...
																		<div class="col-lg-12 col-12">
																			<div class="form-group">
																				<label>Escreva uma avaliação</label>
																...
																<p class="text-center p-5">
																	Você precisa <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Logar</a> OU <a style="color:blue" href="{{route('register.form')}}">Registrar-se</a>
                                    ...
                                    <div class="product-img">
                                        ...
                                        <div class="button-head">
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#modelExample" title="Quick View" href="#"><i class=" ti-eye"></i><span>Loja rápida</span></a>
                                                <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Adicione à lista de desejos</span></a>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="quickview-content">
                            <h2>Vestido de turno queimado</h2>
