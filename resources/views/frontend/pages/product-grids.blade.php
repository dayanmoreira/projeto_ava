...
@section('title','DonutsYume || PRODUCT PAGE')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="blog-single.html">Grade da loja</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="shop-sidebar">
                                ...
                                <!-- Shop By Price -->
                                    <div class="single-widget range">
                                        <h3 class="title">Compra por preço</h3>
                                            ...
                                            <div class="product-img">
                                                ...
                                                <div class="button-head">
                                                    <div class="product-action">
                                                        ...
                                                        <a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}" class="wishlist" data-id="{{$product->id}}"><i class=" ti-heart "></i><span>Adicione à lista de desejos</span></a>
                                                    </div>
