								...
								@else
										<tr>
											<td class="text-center">
												Não há carrinhos disponíveis. <a href="{{route('product-grids')}}" style="color:blue;">Continue fazendo compras</a>
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">Você economizará<span>${{number_format(Session::get('coupon')['value'],2)}}</span></li>
										@endif
										@php
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">Você Pagará<span>${{number_format($total_amount,2)}}</span></li>
										@else
											<li class="last" id="order_total_price">Você Pagará<span>${{number_format($total_amount,2)}}</span></li>
										@endif
									</ul>
									<div class="button5">
										...
										<a href="{{route('product-grids')}}" class="btn">Continue fazendo compras</a>
									</div>
								</div>
							</div>
						</div>
