...
@section('title','DonutsYume || Blog Detail page')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Barra lateral</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="blog-single-main">
                        <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group button">
                                                        <button type="submit" class="btn"><span class="comment_btn comment">Publique comentário</span><span class="comment_btn reply" style="display: none;">Responder Comentário</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <p class="text-center p-5">
                                Você precisa fazer <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Login</a> OU <a style="color:blue" href="{{route('register.form')}}">Registrar-se</a> para comentar.
                            ...
                            <div class="col-12">
                                <div class="comments">
                                    <h3 class="comment-title">Comentários ({{$post->allComments->count()}})</h3>
                                    <!-- Single Comment -->
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget recent-post">
                            <h3 class="title">Postagens Recentes</h3>
                        ...
                        <div class="single-widget newsletter">
                            ...
                            <div class="letter-inner">
                                <h4>Inscreva-se e receba as últimas atualizações.</h4>
